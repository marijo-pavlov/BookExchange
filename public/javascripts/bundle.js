...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainLayout = __webpack_require__(216);
	...
	var _AllBooks = __webpack_require__(225);

	var _AllBooks2 = _interopRequireDefault(_AllBooks);

	var _MyBooks = __webpack_require__(226);

	var _MyBooks2 = _interopRequireDefault(_MyBooks);

	var _Register = __webpack_require__(227);
	...
	var _Logout = __webpack_require__(229);
	...
	(0, _reactDom.render)(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouter.Route, { path: '/account', component: _Account2.default, onEnter: requireAuth }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loginRequest(username, password, cb) {
	  _superagent2.default.post('/api/login').send({ username: username, password: password }).end(function (err, res) {
	    if (err) {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"h1",
						null,
						"Hello to BookExchange!"
					),
					_react2.default.createElement(
						"p",
						null,
						"BookExchange is a service for exchanging books."
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AllBooks = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			_superagent2.default.post('/api/getbooksandrequests').send({
		...
		proposeTrade: function proposeTrade(book) {
			var self = this;

			_superagent2.default.post('/api/proposetrade').send({
				token: _auth2.default.getToken(),
				book: book
			}).end(function (err, res) {
				if (res.body.success) {
		...
		eachSentRequest: function eachSentRequest(request, i) {
			...
			if (found) {
				return _react2.default.createElement(
					'div',
					{ className: 'col-sm-3 col-xs-6', key: i },
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement('img', { src: found.imageLink, className: 'img-responsive img-thumbnail' }),
								_react2.default.createElement(
									'div',
									{ className: 'overlay' },
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-remove request', 'aria-hidden': 'true', onClick: this.withdrawProposal.bind(null, request) })
								)
							)
						)
					)
		...
		eachRecivedRequest: function eachRecivedRequest(request, i) {
			var found = this.state.books.find(function (element) {
				return request.book === element._id;
			});
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: 'overlay' },
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-ok request', 'aria-hidden': 'true', onClick: this.withdrawProposal.bind(null, request) }),
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-remove request2 pull-right', 'aria-hidden': 'true', onClick: this.withdrawProposal.bind(null, request) })
								)
							)
						)
					)
		...
		acceptProposal: function acceptProposal(proposal) {
			...
			_superagent2.default.post('/api/accepttrade').send({
				token: _auth2.default.getToken(),
				request: proposal
			}).end(function (err, res) {
				if (err) throw err;
		...
		rejectProposal: function rejectProposal(proposal) {
			var self = this;

			_superagent2.default.post('/api/rejecttrade').send({
				token: _auth2.default.getToken(),
				request: proposal
			}).end(function (err, res) {
				if (err) throw err;
		...
		withdrawProposal: function withdrawProposal(proposal) {
			var self = this;
		...
		eachBook: function eachBook(book, i) {
			...
			if (!found) {
				...
				if (!found) {
					return _react2.default.createElement(
						'div',
						{ className: 'col-sm-3 col-xs-4', key: i },
						_react2.default.createElement(
							'div',
							{ className: 'row' },
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{ className: 'overlayParent' },
									_react2.default.createElement('img', { src: book.imageLink, className: 'img-responsive img-thumbnail' }),
									_react2.default.createElement(
										'div',
										{ className: 'overlay' },
										_react2.default.createElement('span', { className: 'glyphicon glyphicon-repeat book', 'aria-hidden': 'true', onClick: this.proposeTrade.bind(null, book) })
									)
								)
							)
						)
		...
		array_chunk: function array_chunk(arr, size) {
			if (!Array.isArray(arr)) {
				return [];
			}
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				this.state.success && _react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ type: 'button', className: 'close', 'aria-label': 'Close', onClick: this.removeSuccess },
						_react2.default.createElement(
							'span',
							{ 'aria-hidden': 'true' },
							'×'
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.state.sentRequests.length === 0 ? _react2.default.createElement(
							'p',
						...
						this.state.sentRequests.length !== 0 ? _react2.default.createElement(
						 ...
						 //http://stackoverflow.com/questions/36318601/react-js-every-nth-item-add-opening-tag-or-closing-tag
						rows.sentRequests.map(function (row, i) {
							return _react2.default.createElement(
								'div',
								{ className: 'row', key: i },
								row.map(_this.eachSentRequest)
							);
						})
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'h4',
							null,
							'Requests you have recived'
						),
						this.state.recivedRequests.length === 0 ? _react2.default.createElement(
							'p',
							{ className: 'alert alert-info' },
							'You have not recived any request.'
						) : null,
						this.state.recivedRequests.length !== 0 ? _react2.default.createElement(
							'p',
							null,
							...
							' to accept or click the ',
							_react2.default.createElement('span', { className: 'glyphicon glyphicon-remove', 'aria-hidden': 'true' }),
							' to remove a request.'
						) : null,
						 //http://stackoverflow.com/questions/36318601/react-js-every-nth-item-add-opening-tag-or-closing-tag
						rows.recivedRequests.map(function (row, i) {
							return _react2.default.createElement(
								'div',
								{ className: 'row', key: i },
								row.map(_this.eachRecivedRequest)
							);
						})
					)
				),
				...
				this.state.books.length !== 0 ? _react2.default.createElement(
					'p',
					null,
					'Click the ',
				...
				this.state.books.length === 0 ? _react2.default.createElement(
				 ...
				 //http://stackoverflow.com/questions/36318601/react-js-every-nth-item-add-opening-tag-or-closing-tag
				rows.books.map(function (row, i) {
					return _react2.default.createElement(
						'div',
						{ className: 'row', key: i },
						row.map(_this.eachBook)
					);
				})
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyBooks = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			_superagent2.default.post('/api/getmybooks').send({
				token: _auth2.default.getToken()
			}).end(function (err, res) {
				if (err) throw err;
		...
		searchBooks: function searchBooks(event) {
			...
			_superagent2.default.get('https://www.googleapis.com/books/v1/volumes?q=' + query).end(function (err, res) {
				if (err) throw err;
		...
		addNewBook: function addNewBook(book) {
			...
			_superagent2.default.post('/api/newbook').send({
				token: _auth2.default.getToken(),
				book: book
			}).end(function (err, res) {
				if (err) throw err;
		...
		removeBook: function removeBook(book) {
			...
			_superagent2.default.post('/api/removebook').send({
				token: _auth2.default.getToken(),
				book: book
			}).end(function (err, res) {
				if (err) throw err;
		...
		eachMyBook: function eachMyBook(book, i) {
			return _react2.default.createElement(
				'div',
				{ className: 'col-sm-3 col-xs-4', key: i },
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'overlay' },
								_react2.default.createElement('span', { className: 'glyphicon glyphicon-remove book', 'aria-hidden': 'true', onClick: this.removeBook.bind(null, book) })
							)
						)
					)
				)
			...
			if (book.volumeInfo.imageLinks) {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'overlayParent' },
								_react2.default.createElement('img', { src: book.volumeInfo.imageLinks.thumbnail, className: 'img-responsive img-thumbnail' }),
								_react2.default.createElement(
									'div',
									{ className: 'overlay' },
									_react2.default.createElement('span', { className: 'glyphicon glyphicon-plus book', 'aria-hidden': 'true', onClick: this.addNewBook.bind(null, book) })
								)
							)
						)
					)
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'overlayParent' },
						_react2.default.createElement('img', { src: 'http://placehold.it/200x200', className: 'img-responsive img-thumbnail', onClick: this.addNewBook.bind(null, book) }),
						_react2.default.createElement(
							'div',
							{ className: 'overlay' },
							_react2.default.createElement('span', { className: 'glyphicon glyphicon-plus book', 'aria-hidden': 'true', onClick: this.addNewBook.bind(null, book) })
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.state.myBooks.length !== 0 ? _react2.default.createElement(
							'p',
							null,
							'Click the ',
							_react2.default.createElement('span', { className: 'glyphicon glyphicon-remove', 'aria-hidden': 'true' }),
						...
						this.state.myBooks.length === 0 ? _react2.default.createElement(
							'p',
							{ className: 'alert alert-info' },
							'You currently do not have any book.'
						) : null,
						 //http://stackoverflow.com/questions/36318601/react-js-every-nth-item-add-opening-tag-or-closing-tag
						rows.myBooks.map(function (row, i) {
							return _react2.default.createElement(
								'div',
								{ className: 'row', key: i },
								row.map(_this.eachMyBook)
							);
						})
					)
				),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'form',
							{ onSubmit: this.searchBooks, id: 'newBookForm' },
							_react2.default.createElement(
								'div',
								...
								_react2.default.createElement('input', { ref: 'query', type: 'text', className: 'form-control', placeholder: 'Enter a book title' }),
								_react2.default.createElement('span', { className: 'glyphicon glyphicon-search form-control-feedback', 'aria-hidden': 'true' })
							)
						),
						this.state.searchBooks.length !== 0 ? _react2.default.createElement(
							'p',
							null,
							'Click the ',
				 ...
				 //http://stackoverflow.com/questions/36318601/react-js-every-nth-item-add-opening-tag-or-closing-tag
				rows.searchBooks.map(function (row, i) {
					return _react2.default.createElement(
						'div',
						{ className: 'row', key: i },
						row.map(_this.eachBook)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Register = _react2.default.createClass({
		...
		eachErrorDisplay: function eachErrorDisplay(error, i) {
			return _react2.default.createElement(
				'div',
		...
		eachSuccessDisplay: function eachSuccessDisplay(success, i) {
			return _react2.default.createElement(
				'div',
				{ className: 'alert alert-success', role: 'alert', key: i },
				_react2.default.createElement(
					'span',
					null,
					success.msg
		...
		handleForm: function handleForm(e) {
			...
			var form = {
				...
				password2: _reactDom2.default.findDOMNode(this.refs.password2).value,
				submit: _reactDom2.default.findDOMNode(this.refs.submit).value
			};

			_superagent2.default.post('/api/register').send(form).end(function (err, res) {
				if (err) throw err;
				if (res.body.success) {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { ref: 'username', type: 'text', placeholder: 'Username', className: 'form-control', required: true })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'email', type: 'email', placeholder: 'Enter Email', className: 'form-control', required: true })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'password', type: 'password', placeholder: 'Enter Password', className: 'form-control', required: true })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'password2', type: 'password', placeholder: 'Confirm Password', className: 'form-control', required: true })
					),
					_react2.default.createElement('input', { ref: 'submit', type: 'submit', value: 'Register', className: 'btn btn-default' })
				)
			);
		}
	});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { ref: 'username', type: 'text', placeholder: 'Username', className: 'form-control' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'password', type: 'password', placeholder: 'Enter Password', className: 'form-control' })
					),
					_react2.default.createElement('input', { name: 'submit', type: 'submit', value: 'Login', className: 'btn btn-default' })
				)
			);
		}
	});
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'h2',
					null,
					'You are now logged out. Thank you for using BookExchange.'
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Account = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			var self = this;
			_superagent2.default.post('/api/getinfo').send({
				token: _auth2.default.getToken()
			}).end(function (err, res) {
				if (err) throw err;
		...
		handleSubmit: function handleSubmit(event) {
			...
			var form = {
				token: _auth2.default.getToken(),
				oldpassword: _reactDom2.default.findDOMNode(this.refs.oldpassword).value,
				newpassword: _reactDom2.default.findDOMNode(this.refs.newpassword).value,
				newpassword2: _reactDom2.default.findDOMNode(this.refs.newpassword2).value
			};

			_superagent2.default.post('/api/changepassword').send(form).end(function (err, res) {
				if (err) throw err;
				if (res.body.success) {
					self.setState({
		...
		changeInfo: function changeInfo(event) {
			...
			var form = {
				token: _auth2.default.getToken(),
				name: _reactDom2.default.findDOMNode(this.refs.fullname).value,
				city: _reactDom2.default.findDOMNode(this.refs.city).value,
				state: _reactDom2.default.findDOMNode(this.refs.state).value
			};

			if (form.name || form.email || form.username) {
				_superagent2.default.post('/api/changeinfo').send(form).end(function (err, res) {
					if (err) throw err;
					if (res.body.success) {
						self.setState({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'form',
					{ onSubmit: this.changeInfo, id: 'infoForm' },
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						_react2.default.createElement(
						...
						_react2.default.createElement('input', { type: 'text', placeholder: this.state.user.username, className: 'form-control', disabled: true })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { type: 'text', placeholder: this.state.user.email, className: 'form-control', disabled: true })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'fullname', type: 'text', placeholder: this.state.user.name, className: 'form-control' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'city', type: 'text', placeholder: this.state.user.city, className: 'form-control' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'state', type: 'text', placeholder: this.state.user.state, className: 'form-control' })
					),
					_react2.default.createElement('input', { name: 'submit', type: 'submit', value: 'Change Info', className: 'btn btn-info' })
				),
				_react2.default.createElement(
					'h3',
					null,
				...
				_react2.default.createElement(
					'form',
					{ onSubmit: this.handleSubmit, id: 'passwordForm' },
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						_react2.default.createElement(
						...
						_react2.default.createElement('input', { ref: 'oldpassword', type: 'password', className: 'form-control', required: true })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'newpassword', type: 'password', className: 'form-control', required: true })
					),
					_react2.default.createElement(
						'div',
						{ className: 'form-group' },
						...
						_react2.default.createElement('input', { ref: 'newpassword2', type: 'password', className: 'form-control', required: true })
					),
					_react2.default.createElement('input', { name: 'submit', type: 'submit', value: 'Change Password', className: 'btn btn-info' })
				)
			);
		}
	});
